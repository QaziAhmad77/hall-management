...
export const router = createBrowserRouter(
  createRoutesFromElements(
    <>
      ...
      <Route path="my-halls" element={<ProtectedRoute><MyHalls /></ProtectedRoute>} />
      <Route path="my-hall-detail/:hallId" element={<ProtectedRoute><MyHallDetail /></ProtectedRoute>} />
      <Route path="booked-halls" element={<ProtectedRoute><BookedHalls /></ProtectedRoute>} />

      <Route path="/dashboard" element={<AdminProtectedRoute><MainLayout /></AdminProtectedRoute>}>
